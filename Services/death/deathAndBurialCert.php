  ...
  <script type="text/javascript">
    function printCertificate() {
      ...
      html2canvas(document.getElementById("certificate")).then(function(canvas) {
        ...
        win.document.write('@page { margin:0px 96px; size: auto; } body { margin: 0; } img { width: 98%; height: 100vh; object-fit: contain; border:5px solid #5BB4F4 }');
        win.document.write('html, body { width: 100%; height: 100vh; margin: 0; padding: 0; overflow: hidden; }');
        win.document.write('</style>');
