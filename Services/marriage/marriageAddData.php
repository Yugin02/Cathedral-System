    ...
    if (
      ...
      if (
        ...
        if (
          ...
          $wife_baptismal_imageNew_name = "Wife_Baptismal_" . $wife_familyname . "_" . $wife_name . "." . $wifeBaptismal['ext'];
          ...
          $wife_confirmation_imageNew_name = "Wife_Confirmation_" . $wife_familyname . "_" . $wife_name . "." . $wifeConfirmation['ext'];
          ...
          $husband_baptismal_imageNew_name = "Husband_Baptismal_" . $husband_familyname . "_" . $husband_name . "." . $husbandBaptismal['ext'];
          ...
          $husband_confirmation_imageNew_name = "Husband_Confirmation_" . $husband_familyname . "_" . $husband_name . "." . $husbandConfirmation['ext'];
          ...
          $marriage_certificate_imageNew_name = "Mr_And_Mrs_" . $wife_familyname . "_" . $wife_name . "." . $marriageCert['ext'];
